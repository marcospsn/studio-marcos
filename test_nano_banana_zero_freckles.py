...
# Instruções ultra-rígidas sobre tom de pele mediterrâneo/latino totalmente limpo
prompt = (
    ...
    "SKIN SPECIFICATION: Perfectly clean, smooth-toned olive skin tone without any freckles at all. "
    "COMPLETELY FRECKLE-FREE FACE. ZERO FRECKLES, ZERO SUN SPOTS, ZERO MOLES, ZERO SKIN BLEMISHES. "
    "Natural masculine skin grain with micro-pores, but 100% spotless and clear complexion. "
...
print("\nDisparando geração Nano Banana Pro com pele 100% sem sardas (Clean Complexion)...")
...
if pred.status == "succeeded":
    print("\nIMAGEM COM PELE 100% LIMPA GERADA COM SUCESSO:")
